...
func Init(resetCacheIfNeeded func(mrs []storage.MetricRow)) {
	...
	opts := storage.OpenOptions{
		...
		MaxHourlySeries:       int32(*maxHourlySeries),
		MaxDailySeries:        int32(*maxDailySeries),
